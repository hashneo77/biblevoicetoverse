...
function sortBooksCanonically(books) {
    return [...books].sort((a, b) => {
        const ai = CANONICAL_BOOK_ORDER.findIndex(n => n.toLowerCase() === a.toLowerCase());
        const bi = CANONICAL_BOOK_ORDER.findIndex(n => n.toLowerCase() === b.toLowerCase());
...
function renderBrowserBooks() {
    ...
    const books = bibleData ? sortBooksCanonically(Object.keys(bibleData)) : [];
